...
class ControladorSelecFiltros: ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.vista_seleccionar_filtros)

        // Configura el RecyclerView
        val recyclerView: RecyclerView = findViewById(R.id.recyclerViewFiltros)
        ...
        val buttonConfirmSelection: Button = findViewById(R.id.btn_ConfirmFiltrosSelection)
